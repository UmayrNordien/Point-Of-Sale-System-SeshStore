...
<!--
The aim of the JavaScript Final Project is to create a fully dynamic front end interface for an 
application.  The  application  you  are  expected to build  is  a  Point-Of-Sale system that  links 
to the POS local storage
-->